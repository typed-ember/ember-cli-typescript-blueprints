...
module.exports = function (type, baseClass, options) {
  ...
  let applicationTypeScriptEntityPath = path.join(
    options.project.root,
    'app',
    `${type}s`,
    'application.ts'
  );
  let applicationJavaScriptEntityPath = path.join(
    options.project.root,
    'app',
    `${type}s`,
    'application.js'
  ...
  let hasApplicationEntity =
    fs.existsSync(applicationJavaScriptEntityPath) ||
    fs.existsSync(applicationTypeScriptEntityPath);
