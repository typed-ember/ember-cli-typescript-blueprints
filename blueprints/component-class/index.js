...
module.exports = {
  ...
  locals(options) {
    ...
    const typescriptComponentSignature = `${EOL}interface ${classifiedModuleName}ComponentSignature {}${EOL}`;
    const typescriptDefaultExport = `class ${classifiedModuleName}Component extends Component<${classifiedModuleName}ComponentSignature> {}`;
    ...
    switch (componentClass) {
      case '@ember/component':
        ...
        if (OCTANE) {
          componentSignature = typescriptComponentSignature;
