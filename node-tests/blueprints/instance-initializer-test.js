...
describe('Blueprint: instance-initializer', function() {
  ...
  describe('in app - module unification', function() {
    ...
    it('instance-initializer foo', function() {
      return emberGenerateDestroy(['instance-initializer', 'foo'], _file => {
        expect(_file('src/init/instance-initializers/foo.ts')).to.equal(
          fixture('instance-initializer/instance-initializer.ts')
        );

        expect(_file('src/init/instance-initializers/foo-test.ts')).to.contain(
    ...
    it('instance-initializer foo/bar', function() {
      return emberGenerateDestroy(['instance-initializer', 'foo/bar'], _file => {
        expect(_file('src/init/instance-initializers/foo/bar.ts')).to.equal(
          fixture('instance-initializer/instance-initializer-nested.ts')
        );

        expect(_file('src/init/instance-initializers/foo/bar-test.ts')).to.contain(
  ...
  describe('in addon - module unification', function() {
    ...
    it('instance-initializer foo/bar', function() {
      return emberGenerateDestroy(['instance-initializer', 'foo/bar'], _file => {
        ...
        expect(_file('src/init/instance-initializers/foo/bar-test.ts'));
      });
    });

    it('instance-initializer foo --dummy', function() {
      return emberGenerateDestroy(['instance-initializer', 'foo', '--dummy'], _file => {
        expect(_file('tests/dummy/src/init/instance-initializers/foo.ts')).to.equal(
          fixture('instance-initializer/instance-initializer.ts')
        );

        expect(_file('src/init/instance-initializers/foo.ts')).to.not.exist;

        expect(_file('src/init/instance-initializers/foo-test.ts')).to.not.exist;
      });
    });

    it('instance-initializer foo/bar --dummy', function() {
      return emberGenerateDestroy(['instance-initializer', 'foo/bar', '--dummy'], _file => {
        expect(_file('tests/dummy/src/init/instance-initializers/foo/bar.ts')).to.equal(
          fixture('instance-initializer/instance-initializer-nested.ts')
        );

        expect(_file('src/init/instance-initializers/foo/bar.ts')).to.not.exist;

        expect(_file('src/init/instance-initializers/foo/bar-test.ts')).to.not.exist;
      });
    });
  });
});
