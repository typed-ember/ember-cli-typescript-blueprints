...
describe('Blueprint: instance-initializer-test', function() {
  ...
  describe('in app', function() {
    ...
    describe('with ember-mocha@0.14.0', function() {
      ...
      it('instance-initializer-test foo for mocha', function() {
        return emberGenerateDestroy(['instance-initializer-test', 'foo'], _file => {
          expect(_file('tests/unit/instance-initializers/foo-test.ts')).to.equal(
            fixture('instance-initializer-test/mocha-rfc232.ts')
          );
        });
      });
    });
  ...
  describe('in app - module unification', function() {
    ...
    describe('with ember-cli-qunit@4.1.0', function() {
      ...
      it('instance-initializer-test foo', function() {
        return emberGenerateDestroy(['instance-initializer-test', 'foo'], _file => {
          expect(_file('src/init/instance-initializers/foo-test.ts')).to.equal(
            fixture('instance-initializer-test/module-unification/default.ts')
          );
        });
      });
    });
    ...
    describe('with ember-cli-qunit@4.2.0', function() {
      ...
      it('instance-initializer-test foo', function() {
        return emberGenerateDestroy(['instance-initializer-test', 'foo'], _file => {
          expect(_file('src/init/instance-initializers/foo-test.ts')).to.equal(
            fixture('instance-initializer-test/module-unification/rfc232.ts')
          );
        });
      });
    });
    ...
    describe('with ember-cli-mocha', function() {
      ...
      it('instance-initializer-test foo for mocha', function() {
        return emberGenerateDestroy(['instance-initializer-test', 'foo'], _file => {
          expect(_file('src/init/instance-initializers/foo-test.ts')).to.equal(
            fixture('instance-initializer-test/module-unification/mocha.ts')
          );
        });
      });
    });
    ...
    describe('with ember-mocha@0.14.0', function() {
      ...
      it('instance-initializer-test foo for mocha', function() {
        return emberGenerateDestroy(['instance-initializer-test', 'foo'], _file => {
          expect(_file('src/init/instance-initializers/foo-test.ts')).to.equal(
            fixture('instance-initializer-test/module-unification/mocha-rfc232.ts')
          );
        });
      });
    });
  ...
  describe('in addon - module unification', function() {
    ...
    describe('with ember-cli-qunit@4.1.0', function() {
      ...
      it('instance-initializer-test foo', function() {
        return emberGenerateDestroy(['instance-initializer-test', 'foo'], _file => {
          expect(_file('src/init/instance-initializers/foo-test.ts')).to.equal(
            fixture('instance-initializer-test/module-unification/dummy.ts')
          );
        });
      });
      ...
      it('instance-initializer-test foo --dummy', function() {
        return emberGenerateDestroy(['instance-initializer-test', 'foo', '--dummy'], _file => {
          expect(_file('tests/dummy/src/init/instance-initializers/foo-test.ts')).to.equal(
            fixture('instance-initializer-test/module-unification/dummy.ts')
          );
        });
      });
